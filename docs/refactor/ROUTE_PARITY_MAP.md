...
| `/lostFound/new`       | `/lost-found/new`       | Ready  | full create editor, multipart submit            |
| `/lostFound/[id]/edit` | `/lost-found/[id]/edit` | Ready  | full edit editor, prefilled form + image remove |

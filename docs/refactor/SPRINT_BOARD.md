...
| RF-800 | 8      | FE convention governance upgrade (`FE Lead + FE x2`)   | FE Lead           | ValidatorPass | pending  | Primary-source research synthesis + FE rulebook + team role realignment              |
| RF-810 | 8      | Utility convention phase-1 enforcement                 | FE Specialist A/B | ValidatorPass | pending  | Shared lexical utility consolidation + object/query utility hardening                |

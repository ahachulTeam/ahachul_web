...
// import { usePostComplaintMessage } from "@/services";
...
//   {} as { message: string; setMessage: Dispatch<SetStateAction<string>> },
// );
...
//   useEffect(() => {
//     if (
//       Object.keys(ComplaintContentsKeys).findIndex(
//         (item) => item === String(router.query.id),
//       ) === -1
//     ) {

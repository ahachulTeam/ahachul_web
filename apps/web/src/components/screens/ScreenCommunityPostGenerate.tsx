...
//   const { methods, errors } = useCommunityPostGenerate(pictures);
...
//               조약의 체결·비준에 대한 동의권을 가진다. 모든 국민은 언론·출판의
//               자유와 집회·결사의 자유를 가진다. 대한민국은 민주공화국이다.
//               국무회의는 정부의 권한에 속하는 중요한 정책을 심의한다. 근로조건의
//               기준은 인간의 존엄성을 보장하도록 법률로 정한다. 대법관은
//               대법원장의 제청으로 국회의 동의를 얻어 대통령이 임명한다. 모든

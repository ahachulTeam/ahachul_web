...
//   const [nicknameStatus, setNicknameStatus] = useState<boolean | undefined>(
//     undefined,
//   );

//   const {
//     data: isNicknameSuccess,
//     isLoading,
//     mutate: verifyNicknameMutate,
//   } = useVerifyNickname();
...
//   useEffect(() => {
//     !isLoading &&
//       setNicknameStatus(isNicknameSuccess?.result?.available as boolean);
...
//                   <p
//                     style={{ color: "red" }}
//                     id="nickname-duplicated-error-id"
//                     role="alert"
//                   >
//                     사용불가한 닉네임 입니다.
//                   </p>

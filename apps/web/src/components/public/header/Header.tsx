...
//     if (
//       storage.getItem(PATH_STORAGE_KEYS.PREV_PATH) === "" ||
//       !storage.getItem(PATH_STORAGE_KEYS.PREV_PATH)
//     ) {
...
//             {hasGoBack && (
//               <Header.GoBack onClick={goBackToHome ? goHome : goBack} />
//             )}
//             {!hasGoBack && hasLogo && <Header.Logo onClick={goHome} />}
//           </S.LeftIcon>
//           <S.Title css={invisibleTitle && theme.a11y.visuallyHidden}>
//             {title}
//           </S.Title>
...
//   const handleRouteToAlarmPage = () =>
//     router.push({ pathname: PATH.ALARM, query: { category: "all" } });
...
// function SearchBarWithRankingHashtags({
//   children,
//   onClick,
// }: PropsWithChildren<HeaderBtnProps>) {

...
// export const useCommunityPostGenerate = (pictures: Picture[]) => {
...
//     categoryType,
//     subwayLineId,
//   }: CreateArticleQueryModel) => {
//     if (!methods.getValues("subwayLineId")) {
//       return methods.setError("subwayLineId", {
//         message: "호선을 선택해 주세요.",
//       });
//     }
...
//     methods.handleSubmit(handleCreate, handleError)();

...
export const useFetchLostPostDetail = (lostId: string): UseQueryResult<type.LostDetail> => {
...
export const useFetchLostPosts = (lostType: type.LostType): UseInfiniteQueryResult<type.LostPostsResponse> => {

...
import {
  exportBannerImageWidthLineId,
  exportLineNameWithSubwayLineId,
} from '@/src/utils/export';

export default function Community({}: InferGetServerSidePropsType<
...
export const getServerSideProps: GetServerSideProps<{
  ...
  if (isEmpty(params)) {
    const metaData = {
      ...
      image: 'https://static.ahhachul.com/images/community_page_banner.png',
    };

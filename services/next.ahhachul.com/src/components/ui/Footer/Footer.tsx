...
import down from '@/src/static/img/ahhachul_info_down.png';
import kakao from '@/src/static/img/ahhachul_info_kakao.png';
import naver from '@/src/static/img/icon_naver.png';
import facebook from '@/src/static/img/ahhachul_info_facebook.png';
import insta from '@/src/static/img/ahhachul_info_insta.png';
import youtube from '@/src/static/img/icon_youtube.png';
import ahhachulLogo from '@/src/static/img/logo.png';

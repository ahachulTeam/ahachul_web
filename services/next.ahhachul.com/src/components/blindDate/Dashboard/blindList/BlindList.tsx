...
import { useGetBlindList } from '@/src/queries/blindDate/useGetBlindList';
import { CSSObject, Theme } from '@emotion/react';
import { f } from '@/src/styles';
import IconBlindMembership from '@/src/static/icons/blindDate/IconBlindMembership';
import IconCheckFill from '@/src/static/icons/blindDate/IconCheckFill';
import IconLocation from '@/src/static/icons/blindDate/IconLocation';

...
import bagImg from 'static/img/lost/bag.png';
import galaxyImg from 'static/img/lost/galaxy.png';
import iphoneImg from 'static/img/lost/iphone.png';
import walletImg from 'static/img/lost/wallet.png';

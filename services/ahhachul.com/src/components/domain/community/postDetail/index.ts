export { default as CommunityDetail } from './template/CommunityDetail.component';
export { default as CommunityErrorPage } from './error/CommunityErrorPage.component';
export { default as CommunityDetailSkeleton } from './skeleton/CommunityDetail.skeleton';

...
import 열차번호어딨는지알려주는모달이미지 from "./icons/열차번호어딨는지알려주는모달이미지.png";
  ...
  return (
    <BottomSheet isShowing={isShowing} onClickOutside={onClose}>
      <Flex
        as="section"
        direction="column"
        style={{ width: "100%", paddingTop: "45px", paddingBottom: "30px" }}
      >
        <Box
          style={{
            width: "100%",
        ...
        >
          ...
          <Text
            as="pre"
            fontSize="md"
            style={{ fontWeight: 500, color: "#7F8084", lineHeight: "145%" }}
          >
            {

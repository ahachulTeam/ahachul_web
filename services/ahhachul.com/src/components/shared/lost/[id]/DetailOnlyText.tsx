...
import { Heading, Flex, Text, Divider } from '@ahhachul/react-components-layout';
    ...
    <>
      <Flex direction="column" style={{ padding: '20px 20px 0 20px' }}>
        ...
        <Flex align="center" style={{ margin: '16px 0' }}>
          <Text fontSize="xs" style={{ fontWeight: 500, color: '#171717', marginRight: '8px' }}>
            아이워너굿컴퍼니
          </Text>
      ...
      <Flex direction="column" gap="16px" style={{ backgroundColor: '#F8F9FB', padding: '16px 22px' }}>
        <Flex
          direction="column"
          style={{
            padding: '16px 22px',
        ...
        >
          ...
          <Text fontSize="sm" style={{ fontSize: '14px', marginBottom: '20px' }}>
          ...
          <Flex align="center" justify="space-between">
            <Flex align="center" gap="20px">
              ...
              <Text fontSize="sm" style={{ fontWeight: 500, color: '#333' }}>
                답글 달기
              </Text>
            </Flex>

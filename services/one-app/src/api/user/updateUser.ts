...
import { API_BASE_URL, RESPONSE_MESSAGES, APIResponseCode } from '@/constant';
import type { TempAuthData } from '@/store/auth';
...
export const updateUser = async (data: { nickname: string; auth: TempAuthData }) => {
  try {

...
export default async function CommentEditDeepLinkPage({ params, searchParams }: Props) {
  ...
  return (
    <main className="min-h-screen bg-gray-10 px-5 py-6">
      <section className="rounded-2xl border border-gray-30 bg-white p-5">
        <h1 className="text-title-small text-gray-100">댓글 수정 딥링크</h1>
        <p className="mt-2 text-body-medium text-gray-70">
          one-app에서는 상세 화면 하단 입력창에서 댓글 수정/답글을 지원합니다.
        </p>

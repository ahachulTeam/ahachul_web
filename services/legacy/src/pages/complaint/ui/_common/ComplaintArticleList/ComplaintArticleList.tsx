...
interface ComplaintArticleListProps extends HTMLAttributes<HTMLSectionElement> {}

const ComplaintArticleList = ({ ...props }: ComplaintArticleListProps) => {
  const { data, hasNextPage, isFetchingNextPage, fetchNextPage } = useGetComplaintList({
    page: 0,
    size: 10,
  });
